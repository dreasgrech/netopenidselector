...
namespace OpenIDSelector
{
    internal class ProviderList
    {
        ...
        List<IProviderRetriever> Retrievers { get; set; }
        ...
        public ProviderList()
        {
            ...
            var providersXMLText = Helpers.ReadEmbeddedResource(ProjectSettings.ProjectName,
                                                                String.Format("{0}.{1}", ProjectSettings.ProjectName,
                                                                              "xml.providers.xml"));
